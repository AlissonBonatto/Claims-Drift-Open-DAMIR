...
from code_acte import Poste_soins, dic 
...
df_aggr.to_csv(r'/raid/datasets/allianzsante/Étude de la dérive de sinistralité/Approche par inflation/DBs/df_aggr_par_postedesoins_v1.csv')
